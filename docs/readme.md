# Evelyn Management UI documentation

The folder contains the documentation for Evelyn Management UI.

We are using [Read the docs](https://readthedocs.org/) to host the documentation and the rendered version
can be found [here](https://Evelyn-Management-UI.readthedocs.io).
