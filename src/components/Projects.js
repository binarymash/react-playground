...
class Projects extends Component {
  ...
  render() {
    ...
    return (
      <section>
        <h2>Projects <Badge>{this.props.projects.length}</Badge></h2>
        <Panel>
          <Panel.Heading>
            <ButtonToolbar>
              <Button className='pull-right' bsSize='small' bsStyle='success' onClick={this.handleAddClick}><Glyphicon glyph='plus' /> Add new project</Button>
            </ButtonToolbar>
          </Panel.Heading>
          <Panel.Body>
            <ListGroup>
